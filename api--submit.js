module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const response = await fetch("https://queue.fal.run/fal-ai/flux-pulid", {
      ...
      body: JSON.stringify({
        prompt: prompt,
        negative_prompt: negative_prompt || "bad quality, worst quality, text, watermark, extra limbs, deformed, ugly, blurry, disfigured, mutation, cropped, out of frame, cartoon, anime, illustration, painting, drawing, cgi, 3d render",
        reference_image_url: image_url,
        image_size: image_size || "portrait_4_3",
        num_inference_steps: 28,
        guidance_scale: 4,
        id_weight: id_weight || 1.1,
        true_cfg: 1,
